"""
Automated Pytest for cryo-em-density-validation-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    CryoemdensityvalidationagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = CryoemdensityvalidationagentEnrichmentSuite()
