"""
Command Line Interface for Cryo Em Density Validation Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="cryo-em-density-validation-agent", description="Cryo Em Density Validation Agent")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Cryo Em Density Validation Agent Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Cryo Em Density Validation Agent API server on http://{args.host}:{args.port}")
