...
**Cryo Em Density Validation Agent** is an advanced analytical and computational platform implementing Fourier Shell Correlation (FSC 0.143) & local resolution cryo-EM map validator.
...
docker run -p 8000:8000 cryo-em-density-validation-agent
```
