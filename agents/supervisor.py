"""
Supervisor Orchestrator & Operations Intelligence for Cryo Em Density Validation Agent.
...
class SystemSupervisor:
    """Master Distributed Component Coordinator for Cryo Em Density Validation Agent."""
    ...
    def __init__(self, model_provider: str = "mock"):
        ...
        self.llm = LLMFactory.create(model_provider, system_name="Cryo Em Density Validation Agent")
